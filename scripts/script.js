...
//May be this is the part to be changed..

// var weather2 = document.getElementsByTagName('A');
// console.log(weather2[1]);
// Event.simulate(weather2[2], 'change');

// function myCickFunction() {
//     weather2[1].click();
// }
// if (weather2 == "haze") {
//     weatherUpdate[0].type = weather2.value;
//     var tempText = "Haze";
//     weatherUpdate[0].name = tempText;
// }

// var weatherUpdate = [{ type: 'name', name: 'name' }];
...
var weather = [
    { type: 'sun', name: 'Clear Sky', id: 1 },
    { type: 'wind', name: 'Windy', id: 2 },
    { type: 'rain', name: 'Haze', id: 3 },
    { type: 'thunder', name: 'Rain', id: 4 },
    { type: 'snow', name: 'Snow', id: 5 }
];
...
function init() {
    ...
    for (var i = 0; i < weather.length; i++) {
        ...
        w.button = b;
        // console.log(b);
        var canp = b.bind('click', w, changeWeather);
        // console.log(canp);
    }
